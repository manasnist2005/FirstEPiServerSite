...
namespace FirstEPiServerSite.Business
{
    public class SearchService
    {
        ...
        public IQueryExpression CreateQuery(string searchText, IEnumerable<ContentReference> searchRoots, HttpContextBase context, string languageBranch)
        {
            ...
            var pageTypeQuery = new GroupQuery(LuceneOperator.OR);
